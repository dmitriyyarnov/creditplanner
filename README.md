...
Приложение позволяет добавлять, фильтровать и удалять кредиты, просматривать статистику по месяцам и экспортировать данные в Excel.
...
- Визуализация платежей по месяцам с интерактивным графиком (Plotly)
